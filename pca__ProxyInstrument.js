...
/*//////////////////////////////////////////////////////////////////////////////
			this.wrapper = function (obj, depth, parent, name) {
				//console.log(obj, name, testObject(obj,name));
				if(!testObject(obj,name, parent) || depth <= 1) return obj;
				
				for(var p in obj) {
					var test = testObject(obj[p],p,obj);
					if(test) obj[p] = this.wrapper(obj[p], (depth >=0 ? depth-1 : maxDepth) , obj, p);
				}
