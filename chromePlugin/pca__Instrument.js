...
///////////////////////////////////////////////////////////////////////////////
			var wrapFunction = function(method, depth, parent, name) {
				...
				var wrapper = function() {
						if(arguments[0] == "__pca__getWrapped") return method;
			...
			//	else return wrapper;
				...
				Object.defineProperty(wrapper,"__pca__objInfo", {
					writable:true,
					value: method.__pca__objInfo,
				});
...
/*//////////////////////////////////////////////////////////////////////////////
	Public Methods
/*//////////////////////////////////////////////////////////////////////////////
			this.instanceOf = function(obj, func) {
   			if(func.toString() != this.wrapper(this.liner).toString()) return (obj instanceof func);
   			else return (obj instanceof func("__pca__getWrapped"));
			}
///////////////////////////////////////////////////////////////////////////////
